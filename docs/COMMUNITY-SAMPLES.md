...
|-------------------------------------|---------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------|--------------------------------------------------------------------------|-----------------------------|
| [Infraclassify](https://github.com/mrsadengineer/InfraClassify) | Use deep learning to classify images of infrastructure (bridges, roads, etc) inside a web application | image classification | ML.NET 1.6.0 | Kudos for Sam D. (mrsadengineer) |  
| [GymRogueOne (Reinforcement Learning)](https://github.com/JimFFM/ml-hackathon-2021/)  | Consume an ONNX reinforcement learning model with ML.NET using a .NET websocket server and Godot 3D engine | reinforcement learning | ML.NET v1.7.0 | Kudos for Jim SEOW (JimFFM), Shehroze Malik (shehrozeee), Praveen Raghuvanshi (praveenraghuvanshi)      |
| [TorchDataLoader](https://github.com/dayo05/TorchDataLoader) | Data loading utility similar to `torch.utils.data` using .NET IEnumerable interface. | N/A | Kudos for Dayo (dayo05) 
