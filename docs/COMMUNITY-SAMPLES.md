...
|-------------------------------------|---------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------|--------------------------------------------------------------------------|-----------------------------|
| [Inclusive Code Reviews](https://github.com/jonathanpeppers/inclusive-code-reviews-ml) | The goal of this project is to produce a machine learning model for classifying sentences for code reviews. | Binary Classification, Sentiment Analysis || Kudos for Jonathan Peppers (jonathanpeppers) and the DevDiv Inclusive Code Reviews v-team |
...
| [Real-Time Object Detection](https://github.com/mrsadengineer/mlnet-hackathon-2020-submission)  | Use ML.NET apply object detection to real-time web cam footage | object detection model | ML.NET v1.5.2 | Kudos for Sam (msadengineer)      |
