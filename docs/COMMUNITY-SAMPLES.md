...
|-------------------------------------|---------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------|--------------------------------------------------------------------------|-----------------------------|
| [Photo-Search](https://github.com/Tak-Au/Photo-Search)  | Sample WPF app running an ONNX model built with Keras model and exported to that ONNX model format, then used from in WPF app with ML.NET. | Most in ML.NET | Updated to ML.NET v0.9 and .NET Core 3.0 | Kudos for Tak-Au      |
