    ...
    class Program
    {
        ...
        public static ITransformer TrainModel(MLContext mlContext, IDataView trainDataView)
        {
            ...
            IEstimator<ITransformer> dataProcessPipeline = mlContext.Transforms.Concatenate("Features", featureColumnNames)
                                            ...
                                            .Append(mlContext.Transforms.Conversion.ConvertType("LabelValue", "Label"));

            IEstimator<ITransformer> dataProcessPipelineNormalized = dataProcessPipeline.Append(mlContext.Transforms.NormalizeMeanVariance(inputColumnName: "Features", outputColumnName: "FeaturesNormalizedByMeanVar"));
            ...
            var options = new RandomizedPcaTrainer.Options
            {
                ...
                Seed = null                                         // The seed for random number generation.
            };
            ...
            // Append feature contribution calculator in the pipeline. This will be used at prediction time for explainability. 
