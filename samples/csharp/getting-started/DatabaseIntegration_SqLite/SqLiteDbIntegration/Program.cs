...
namespace DatabaseIntegration
{
    public class Program
    {
        ...
        public static void Main()
        {
            ...
            Console.WriteLine($"\n \n Test {trainTestData.TestSet} transactions, from the test datasource, that should be predicted as fraud (true):");

            var recordsToPredict = mlContext.Data.CreateEnumerable<AdultCensus>(trainTestData.TestSet, reuseRowObject: false).Take(5);
        ...
        //public static void PrintToConsole(Model transaction)
        //{
