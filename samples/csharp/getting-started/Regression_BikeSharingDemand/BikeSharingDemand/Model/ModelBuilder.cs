...
namespace BikeSharingDemand.Model
{
    public sealed class ModelBuilder
    {
        ...
        public EstimatorChain<ITransformer> TransformDataInPipeline()
        {
            ...
            ConsoleHelper.PeekDataViewInConsole(_mlcontext, _dataView, pipeline, 10);
            ConsoleHelper.PeekFeaturesColumnDataInConsole("Features", _mlcontext, _dataView, pipeline, 10);

            return pipeline;

            //Train with SdcaRegressionTrainer
            //var _pipelineToFit = _pipeline.Append(new SdcaRegressionTrainer(_mlcontext,
            ...
            //var model = _pipelineToFit.Fit(_dataView);
        ...
        public TransformerChain<RegressionPredictionTransformer<LinearRegressionPredictor>> 
                    BuildAndTrainWithSdcaRegressionTrainer(EstimatorChain<ITransformer> pipeline)
        {
            ...
            Console.WriteLine("=============== Training model ===============");
            var model = pipelineWithTrainer.Fit(_dataView);
        ...
        private void TestSinglePrediction(TransformerChain<RegressionPredictionTransformer<LinearRegressionPredictor>> model)
        {
            //Prediction test
            // Create prediction engine and make prediction.
            var engine = model.MakePredictionFunction<BikeSharingDemandSample, BikeSharingDemandPrediction>(_mlcontext);
        ...
        public TransformerChain<RegressionPredictionTransformer<PoissonRegressionPredictor>>
            BuildAndTrainWithPoissonRegressionTrainer(EstimatorChain<ITransformer> pipeline)
        {
