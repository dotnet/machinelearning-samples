...
namespace ObjectDetection
{
    ...
    //        var pipeline = mlContext.Transforms.LoadImages(imageFolder: imagesFolder, columns: (outputColumnName: "ImageReal", inputColumnName: "data_0"))
    //                      .Append(mlContext.Transforms.Resize(outputColumnName: "ImageReal", imageWidth: imageWidth, imageHeight: imageHeight, inputColumnName: "ImageReal"))
