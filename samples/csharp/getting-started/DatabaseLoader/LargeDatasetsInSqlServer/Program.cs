using Common;
using LargeDatasetsInSqlServer.DataModels;
using Microsoft.ML;
...
namespace LargeDatasetsInSqlServer
{
    ...
    {  
        public static void Main()
        {
            ...
            // localdb SQL database connection string
            string connectionString = @"Data Source=(localdb)\MSSQLLocalDb;Initial Catalog=Criteo25MB;Integrated Security=True;Pooling=False";
            ...
            var loader = mlContext.Data.CreateDatabaseLoader<UrlClick>();
           
            Console.WriteLine("Registered Provider Invariant Names: ");
            ...
            var dataViewSource = new DatabaseSource(providerFactory, connectionString, commandText);
            var dataView = loader.Load(dataViewSource);
