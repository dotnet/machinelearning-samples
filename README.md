...
![High level steps to build an ML model](images/binary-classification-plotting.png)
...
![High level steps to build an ML model](images/multi-class-classification-plotting.png)
<table>
 <tr>
  <td>
...
![High level steps to build an ML model](images/regression-plotting.png)
![High level steps to build an ML model](images/regression-icon.png)
<table>
 <tr>
  <td>
...
![High level steps to build an ML model](images/recommendation-icon.png)
<table>
 <tr>
  <td>
      <h3><a href="TBD/Relative-URL">Sample 1 ML task</a></h3>
...
![High level steps to build an ML model](images/anomaly-detection-plotting.png)
<table>
 <tr>
  <td>
      <h3><a href="TBD/Relative-URL">Sample 1 ML task</a></h3>
...
## Retail samples
![Retail shopping bag icon](images/icon-retail.png)
<table>
 <tr>
  <td>
      <h3><a href="TBD/Relative-URL">Sample 1 ML task</a></h3>
...
![Transportation icon](images/icon-transport.png)
<table>
 <tr>
  <td>
      <h3><a href="TBD/Relative-URL">Taxi Fare Prediction</a></h3>
...
![Financial icon](images/icon-dev-computing.png)
<table>
 <tr>
  <td>
      ...
      ML TASK/AREA: Multi-class classification
      PROBLEM TO SOLVE: Automatically label new GitHub issues added to a repo
      INDUSTRY/BUSINESS: Development & computing
  </td>
  <td>
      <h3><a href="TBD/Relative-URL">Sample 2 ML task</a></h3>
...
![TensorFlow logo](images/icon-any-industry-business.png)
<table>
 <tr>
  <td>
      <h3><a href="TBD/Relative-URL">Classify/Identify an image</a></h3>
